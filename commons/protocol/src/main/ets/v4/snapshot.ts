...
export type StopTargetKind = any;
...
export type ActiveWorkSummary = any;
...
export const errorAttributionSchema = z
  ...
  .strict();
export type ErrorAttribution = any;
...
export type SessionErrorInfo = any;
...
export type SessionControl = any;
...
export type ActionAvailability = any;
...
export type SessionActionAvailability = any;
...
export type SessionMetaState = any;
...
export type SessionUsageState = any;
...
export type PermissionRequestPayload = any;
...
export type UserInputOptionPayload = any;
...
export type UserInputQuestionPayload = any;
...
export type UserInputRequestPayload = any;
...
export type InteractionAutoResolution = any;
...
export type PendingInteraction = any;
...
export type CommandStateSummary = any;
...
export type BackgroundWorkSummary = any;
...
export type RunningSubagentSummary = any;
...
export type SubagentProjectionState = any;
...
export type GoalIterationState = any;
...
export type GoalState = any;

export const planStateSchema = z.object({
  items: z.array(planItemSchema),
  updatedAt: timestampSchema,
});
export type PlanState = any;
...
export type WorkspaceHookAdmissionSnapshotState = any;
...
export type ConversationSnapshot = any;
