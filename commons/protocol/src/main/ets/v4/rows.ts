...
export type RowActions = NonNullable<any>;
...
export type TurnWorkSegment = any;
...
export type AssistantTextRow = any;
...
export const cuaAppIdentitySchema = z
  ...
  .strict();
export type CuaAppIdentity = any;
...
export type ConversationArtifactType = any;
...
export const hookExecutionDescriptorSchema = z
  ...
  .strict();
export type HookExecutionDescriptor = any;
...
export const hookExecutionProjectionSchema = z
  ...
  .strict();
export type HookExecutionProjection = any;
...
export type HookInvocationRow = any;
...
export type TimelineMarkerPayload = any;
...
export type TimelineMarkerLane = any;
...
export type TimelineMarkerRow = any;
