...
export const toolCallGetWorkflowRunDisplaySchema = z
  ...
  .strict();
export type ToolCallGetWorkflowRunDisplay = any;
...
export const toolCallListWorkflowRunsDisplaySchema = z
  ...
  .strict();
export type ToolCallListWorkflowRunsDisplay = any;
...
export const toolCallEvalWorkflowSnippetDisplaySchema = z
  ...
  .strict();
export type ToolCallEvalWorkflowSnippetDisplay = any;
...
export const toolCallSavedWorkflowListDisplaySchema = z
  ...
  .strict();
export type ToolCallSavedWorkflowListDisplay = any;
...
export const toolCallListModelsDisplaySchema = z
  ...
  .strict();
export type ToolCallListModelsDisplay = any;
...
export const toolCallResumeWorkflowRunDisplaySchema = z
  ...
  .strict();
export type ToolCallResumeWorkflowRunDisplay = any;
