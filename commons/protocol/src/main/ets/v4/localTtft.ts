...
export type LocalTtftDetail = any;
...
export type LocalTtftOutputKind = any;
export const localTtftFactsSchema = z
  ...
  .strict();
export type LocalTtftFacts = any;
...
export type LocalTtftRecord = any;
export const localTtftBatchSchema = z
  ...
  .strict();
export type LocalTtftBatch = any;
