...
export const topicWireChecksumSchema = z
  ...
  .strict();
export type TopicWireChecksum = any;
...
export type TopicFrameDeliveryKind = any;
...
export type TopicWireFrameCandidate = any;

export function createTopicWireFrameSchema<F extends unknown>(frameSchema: F) {
  return z
    ...
    .superRefine((wire, context) => {
      const value = wire as unknown as TopicWireFrame<any>;
