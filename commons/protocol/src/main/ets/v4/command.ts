...
import { zcodeBrowserAmbientContextSchema, zcodeProtocolMcpServerSchema } from "./zcode-protocol-min.js";
...
export type CommandPayloadMap = any;
...
export type SavedWorkflowStartRejectionReason = any;
...
export type CommandsQueryParams = any;
...
export const commandQueryItemSchema = z
  ...
  .strict();
export type CommandQueryItem = any;
...
export const commandsQueryResultSchema = z
  ...
  .strict();
export type CommandsQueryResult = any;
