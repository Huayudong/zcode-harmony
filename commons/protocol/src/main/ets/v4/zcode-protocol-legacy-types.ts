...
export const zcodePermissionResponseSchema = z
  ...
  .strict();
export type ZCodePermissionResponse = any;
...
export const zcodeSessionInfoSchema = z
  ...
  .strict();
export type ZCodeSessionInfo = any;
export const zcodeInteractionRequestOriginSchema = z
  ...
  .strict();
export type ZCodeInteractionRequestOrigin = any;
...
export type ZCodeMessageInfo = any;
...
export type ZCodeMessagePart = any;
export const zcodeMessageWithPartsSchema = z
  ...
  .strict();
export type ZCodeMessageWithParts = any;
...
export const zcodeContextUsageBreakdownItemSchema = z
  ...
  .strict();
export type ZCodeContextUsageBreakdownItem = any;
...
export const zcodeSessionRuntimeStateSchema = z
  ...
  .strict();
export type ZCodeSessionRuntimeState = any;
