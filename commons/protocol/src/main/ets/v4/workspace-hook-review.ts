...
export type WorkspaceHookReviewTrustState = any;
...
export type WorkspaceHookReviewDecision = any;
...
export const workspaceHookReviewCommandTargetSchema = z
  ...
  .strict();
export type WorkspaceHookReviewCommandTarget = any;
...
export type WorkspaceHookTrustRevokeTarget = any;
...
export const requestWorkspaceHookReviewTargetSchema = z
  ...
  .strict();
export type RequestWorkspaceHookReviewTarget = any;
...
export type WorkspaceHookReviewRequestPayload = any;
...
export const presentWorkspaceHookReviewRequestSchema = z
  ...
  .strict();
export type PresentWorkspaceHookReviewRequest = any;
